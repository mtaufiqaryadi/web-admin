                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu'] ?></td>
                            <td>
                                <a href="<?= base_url('menu/editmenu/') . $m['id']; ?>" class="badge badge-primary">Edit</a>
                                <a href="<?= base_url('menu/deletemenu/') . $m['id']; ?>" class="badge badge-secondary">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('menu/addmenu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">New Menu</label>
